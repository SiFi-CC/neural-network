...
class DataModel_new():
    ...
    def __mean_features(self):
        ...
        # New factors
        # Change to readin norm. factors from file
    ...
    def generate_training_data(simulation, output_name):
        ...
        reco = np.concatenate((
            ...
            Utils_new.l_vec_as_np(simulation.tree['RecoPosition_e']['position'].array()[l_valid_pos]),
            Utils_new.l_vec_as_np(simulation.tree['RecoPosition_p']['position'].array()[l_valid_pos]),
        ), axis=1)
